    ...
    common: {
        headerTable: {
            ...
            module: {
                ...
                [ModuleName.STORE_MATERIAL]: 'Category',
                [ModuleName.STORE_CONVERT]: 'Category',
                [ModuleName.STORE_SUPPLIER]: 'Category',
                [ModuleName.STORE_IMPORT_MATERIAL]: 'Category',
                [ModuleName.STORE_IMPORT_MATERIAL_DETAIL]: 'Category',
                [ModuleName.STORE_EXPORT]: 'Category',
                [ModuleName.STORE_EXPORT_MATERIAL_DETAIL]: 'Category',
                [ModuleName.STORE_CHECK_INVENTORY]: 'Category',
                [ModuleName.STORE_INVENTORY_DETAIL]: 'Category',
